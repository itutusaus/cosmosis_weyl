...
class Power3D(object):
    ...
    def set_nonlimber_splines(self, block, chi_of_z, k_growth=1.e-3):
        ...
        #IT 14/09/23
        self.lin_growth_spline = interp.InterpolatedUnivariateSpline(chi_lin, np.ones(len(chi_lin)))
        #IT
        ...
        #IT 14/09/23
        P_lin_from_growth = np.outer(np.ones(len(chi_lin))**2, P_lin_z0_resamp)
        #IT
